...
%Dateinamen angeben:
Dateiname = '20160704_V3.xlsx';
%Name der Zieldatei
NeuerDateiname = [Dateiname(1,1:end-5) '_Auswertung' '.xlsx'];
...
%Zeitbereich angeben
Zeitstempel_Anf = '04.07.2016, 16:56:43,778';

Zeitstempel_End = '04.07.2016, 16:58:23,778';
...
%Zahlenreihen den Variablennamen zuordnen und in Workspace schreiben
   for col=1:size(varNames,1),
          assignin ('base',deblank(varNames(col,:)),num(rmin:rmax,col));
   end;
...
[NTU_sen, NTU_lat, k_sen, k_lat] = Berechnung_Uebertragungswerte(PHI_ABL, PHI_AUL, PHI_FOL, PHI_ZUL, T_ABL, T_AUL, T_FOL_PHI, T_ZUL_PHI, x_AUL, P_amb, R);
...
%Tabel erzeugen
ExTab = table(Zeit,T_AUL,T_ABL,T_ZUL_PHI,T_FOL_PHI,PHI_AUL,PHI_ABL,PHI_ZUL,PHI_FOL,x_AUL,x_ABL,x_ZUL,x_FOL,T_ZUL_Mitte,T_ZUL_O,T_ZUL_U,T_ZUL_L,T_ZUL_R,T_FOL_Mitte,T_FOL_O,T_FOL_U,T_FOL_L,T_FOL_R);
